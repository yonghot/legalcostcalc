...
interface AuthorBylineProps {
  /**
   * ISO date (YYYY-MM-DD) the page content was last updated. Defaults to the
   * current year/month at render time so static pages still show a recent date.
   */
  lastUpdated?: string;
  className?: string;
}
 ...
 * date. Keeps trust signals honest and policy-safe for YMYL legal content.
 */
